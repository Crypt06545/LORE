...
class Connect4(commands.Cog):
    ...
    @nextcord.slash_command(name="connect4", description="Play Connect 4.")
    async def connect4(self, interaction: Interaction, player2: nextcord.Member = SlashOption(description="Player to challenge")):
